 ...
 */
export function convertSvgToDeck(svgString, options = {}) {
    ...
    if (opts.extractText) {
        const textCandidates = extractTextDeckNodes(svgRoot, viewBox, opts.defaultFontFamily, opts.defaultFontSize, textCtx);
