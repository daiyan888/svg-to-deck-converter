...
export function GalleryPicker({ onTemplateLoaded, onError }: GalleryPickerProps) {
  ...
  return (
    <div className="galleryPicker">
      <div className="galleryPickerFields">
        <label className="galleryPickerField">
          <span className="galleryPickerLabel">Gallery 类型</span>
          <select
            className="galleryPickerSelect"
            value={categoryId}
        ...
        <label className="galleryPickerField">
          <span className="galleryPickerLabel">具体示例</span>
          <select
            className="galleryPickerSelect"
            value={slug}
