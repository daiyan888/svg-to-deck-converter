...
export function getCategoryId(slug: string): string {
  if (slug.startsWith('hierarchy-mindmap-')) return 'mind-map';
  if (slug.startsWith('hierarchy-tree-')) return 'hierarchy-tree';
  if (slug.startsWith('compare-quadrant-quarter-')) return 'compare-quadrant-quarter';
  if (slug.startsWith('compare-quadrant-simple-')) return 'compare-quadrant-simple';
  if (slug.startsWith('relation-dagre-')) return 'relation-dagre';
  if (slug.startsWith('sequence-interaction-')) return 'sequence-interaction';
...
export function getGalleryTemplateUrl(slug: string): string {
